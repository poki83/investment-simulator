const Taxes = {
    ...
    capitalTarget(net) {
        const taxable = Math.max(0, net - this.PAUSCHBETRAG);
    ...
    getSummary() {
        this.rollTaxYear();
        const t = GameState.taxes;
        const freibetragUsed = Math.min(this.PAUSCHBETRAG, Math.max(0, this.round2(t.capitalNet)));
        return {
            ...
            taxYear: t.taxYear,
            pauschbetrag: this.PAUSCHBETRAG,
